...
export const ROUTES: RouteInfo[] = [
  ...
  {
    path: '', title: 'Accueill', icon: 'ft-home', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
 ...
 /* {
  ...
  {
    path: '', title: 'Gestion des employés', icon: 'ft-edit', class: 'has-sub', badge: '', badgeClass: '', isExternalLink: false,
    submenu: [
      /*{
      ...
      { path: '/forms/layout/:id', title: 'Modifier', icon: 'ft-arrow-right submenu-icon', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
      ...
      { path: '/forms/archwizard', title: 'Ajouter', icon: 'ft-arrow-right submenu-icon', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
      { path: '/dashboard/dashboard2/:id', title: 'Détails', icon: 'ft-arrow-right submenu-icon', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] }
    ]
  },
 /* {
  ...
  {
    path: '/datatables', title: 'Table des employés', icon: 'ft-layout', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: []
  },
  /*{ path: '/dashboard/dashboard2/:id', title: 'Details', icon: 'ft-arrow-right submenu-icon', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },*/
  /*{ path: '/tables/basic', title: 'file', icon: 'ft-arrow-right submenu-icon', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
 /* {
